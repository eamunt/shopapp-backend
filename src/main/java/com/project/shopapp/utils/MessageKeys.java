...
public class MessageKeys {
    ...
    public static final String WRONG_PHONE_OR_PASSWORD = "user.login.wrong_phone_or_password";
    ...
    public static final String CREATE_CATEGORY_FAILED = "category.update_category.create_failed";
    public static final String DELETE_ORDER_SUCCESSFULLY = "order.delete_order.delete_successfully";
    public static final String DELETE_ORDER_DETAILS_SUCCESSFULLY= "orderdetails.delete_order_details.delete_successfully";
